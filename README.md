...
MongrelDB is pulled from crates.io (`mongreldb-core` / `mongreldb-query` **0.60.3** - latest release). No engine source checkout required.
...
```toml
mongreldb-core  = "0.60.3"
mongreldb-query = "0.60.3"
```
