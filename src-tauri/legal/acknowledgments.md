...
| Crate | Role | License |
| ----- | ---- | ------- |
| `mongreldb-core` 0.63.1 | Embedded storage engine | MIT OR Apache-2.0 |
| `mongreldb-query` 0.63.1 | SQL / DataFusion query layer | MIT OR Apache-2.0 |
| `mongreldb-client` 0.63.1 | HTTP client for mongreldb-server | MIT OR Apache-2.0 |
